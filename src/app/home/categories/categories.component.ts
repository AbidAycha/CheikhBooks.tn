...
export class CategoriesComponent implements OnInit {
  ...
  categories = [
    ...
    {id: 1,name:' Novel',des:'fact that a reader will be distracted by the readable content of a page when looking at its layout.Thepoint of using',imagePath:'cat1.png'},
